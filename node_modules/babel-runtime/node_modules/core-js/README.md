...
#### ECMAScript 6: Number
<<<<<<< HEAD
Module [`es6.number.constructor`](https://github.com/zloirock/core-js/blob/v2.6.10/modules/es6.number.constructor.js). `Number` constructor support binary and octal literals, [*example*](http://goo.gl/jRd6b3):
=======
